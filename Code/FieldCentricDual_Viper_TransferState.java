...
@TeleOp
public class FieldCentricDual_Viper_TransferState extends LinearOpMode {
    DcMotorEx worm;
...
if (gamepad2.left_trigger == 1 && transferState == TransferState.IDLE) {
    transferState = TransferState.PICK_POWER;
...
switch (transferState) {
    case PICK_POWER:
        ...
        if (System.currentTimeMillis() - stateStartTime > 600) {
            transferState = TransferState.VIPER_DOWN;
            stateStartTime = System.currentTimeMillis();
        }
        break;
    ...
    case VIPER_DOWN:
        ...
        if (System.currentTimeMillis() - stateStartTime > 250) {
            ...
            viper2.setPower(0);
            dclaw.setPosition(0);
            transferState = TransferState.CLAW_CLOSE;
            stateStartTime = System.currentTimeMillis();
        }
        break;
    ...
    case CLAW_CLOSE:
        flip.setPosition(0);
        if (System.currentTimeMillis() - stateStartTime > 2600) {
            dflip.setPosition(0.95);
            transferState = TransferState.FLIP_RESET;
            stateStartTime = System.currentTimeMillis();
        }
        break;
    ...
    case FLIP_RESET:
        ...
        if (System.currentTimeMillis() - stateStartTime > 100) {
            transferState = TransferState.VIPER_UP;
            stateStartTime = System.currentTimeMillis();
        }
        break;
    ...
    case VIPER_UP:
        viper1.setPower(0.8);
        viper2.setPower(0.8);
        if (System.currentTimeMillis() - stateStartTime > 170) {
            viper1.setPower(0);
            viper2.setPower(0);
            flip.setPosition(0.045);
            transferState = TransferState.FINAL_ADJUSTMENT;
            stateStartTime = System.currentTimeMillis();
        }
        break;
    ...
    case FINAL_ADJUSTMENT:
        ...
        if (System.currentTimeMillis() - stateStartTime > 140) {
            pClaw.setPosition(0);
            transferState = TransferState.IDLE; // Sequence complete
        }
        break;
