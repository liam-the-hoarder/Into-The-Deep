...
@TeleOp
public class FieldDualTeleOp extends LinearOpMode {
    DcMotorEx worm;
       ...
       boolean slpPause = false;
        ...
        while(opModeIsActive()) {
            ...
            switch (leftTriggerState) {
                case PICK_POWER:
                    pick.setPower(0.7);
                    if (System.currentTimeMillis() - leftTriggerStartTime > 600) {
                ...
                case VIPER_UP:
                    viper1.setPower(0.8);
                    viper2.setPower(0.8);
                    if (System.currentTimeMillis() - leftTriggerStartTime > 170) {
                        viper1.setPower(0);
                        viper2.setPower(0);
                ...
                case PCLAW_CLOSE:
                    pClaw.setPosition(0.15);
                    leftTriggerState = LeftTriggerState.COMPLETE; // Sequence is complete
                    break;

                case COMPLETE:
                    leftTriggerState = LeftTriggerState.IDLE;
                    break;
